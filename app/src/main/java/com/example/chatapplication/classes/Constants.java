...
public class Constants {
    ...
    public static String KEY_FARM_ID = "key_farm_id";
    ...
    public static String KEY_SELECTED_DATE = "key_selected_date";
    ...
    public static final String ENGINEER = "engineer", FARMER = "farmer";
